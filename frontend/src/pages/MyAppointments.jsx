...
const MyAppointment = () => {
  ...
  return (
    <div>
      <p className='pb-3 mt-12 font-medium text-zinc-700 border-b'>Appoinments</p>
      <div>
          ...
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2
           border-b' key={index}>
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-xs mt-1'><span className=' text-sm text-neutral-700 font-medium'>Date & Time:</span> 2024-06-15 | 10:00 AM</p>
            </div>
            <div></div>
